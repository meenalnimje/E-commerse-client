...
import { addToCartDetails } from "../cart/cartSlice";
...
export default function Navbar({ children }) {
  ...
  const cartSize = useSelector(addToCartDetails)?.length;
  ...
  useEffect(() => {
    const link = user?.role === "admin" ? "/admin/orders" : "/orders";
    setUserNavigation([
      { name: "Profile", link: "/profile" },
      { name: "Orders", link: link },
